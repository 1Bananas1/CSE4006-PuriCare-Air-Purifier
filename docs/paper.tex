                ...
                \begin{center}
                    ...
                    \renewcommand{\arraystretch}{1.3} 
                        \begin{tabular}{|p{2.1cm}|p{1.4cm}|p{1cm}|p{2cm}|}
                            ...
                            \path{auth.js}
                            \path{controlRoutes.js}
                            \path{deviceRoutes.js}
                            \path{roomRoutes.js}
                            \path{sensorRoutes.js}
                            \path{userRoutes.js}
                            \path{notificationRoutes.js} &
                            REST API Endpoints &
                            ...
                            \path{deviceService.js}
                            \path{sensorDataService.js}
                            \path{notificationService.js}
                            \path{timezoneService.js} &
                            ...
                            \path{aqiScripts.js}
                            \path{midnightRoutine.js}
                            \path{processNotifications.js} &
                ...
                \begin{center}
                    ...
                    \renewcommand{\arraystretch}{1.3} 
                        \begin{tabular}{|p{2.1cm}|p{1.4cm}|p{1cm}|p{2cm}|}
                            ...
                            \path{/hardware/} &
                            \path{collect_cough_samples.py}
                            \path{collect_training_samples.py}
                            \path{quick_collect_samples.py} &
                            Data Collection Scripts &
                            Tools for recording and labeling training data samples \\ \hline
                        \end{tabular}%
                \end{center}
            \end{table}
        \end{enumerate}
