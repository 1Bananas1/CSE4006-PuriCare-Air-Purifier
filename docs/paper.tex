...
\section{Development environment}
    ...
    \subsection{\textbf{Software in Use}}
        \begin{itemize}
            ...
            \item \textbf{Streaming/Backend}: Firebase, Heroku
...
\section{Specification}
    \subsection{\textbf{User Authentication}}
        \subsubsection{Technology Stack}
            \begin{itemize}
                ...
                \item Token Management: Google ID Tokens with localStorage persistence
        ...
        \subsubsection{Authentication Flow}
            \begin{enumerate}
                ...
                \item Token stored in localStorage as JSON: \{ "idToken": "...", "refreshToken": "...", "expiresIn": 3600 \}
        ...
        \subsubsection{Security Measures}
            \begin{itemize}
                ...
                \item Secure localStorage (inaccessible to external scripts)
    ...
    \subsection{\textbf{Real-Time Device Control System}}
        \subsubsection{Communication Architecture}
            ...
            \end{itemize}
        \subsubsection{WebSocket Communication Flow}
            INSERT DIAGRAM HERE
        \subsubsection{Control Command Structure}
            Commands sent from Frontend -> Backend -> Device
            \begin{itemize}
                \item Power Control
                    \begin{itemize}
                        \item type: "power"
    ...
    \subsection{\textbf{Sensor Data Collection \& Time-Series Database}}
        \subsubsection{Database Architecture}
            \begin{itemize}
                ...
                \item Schema: Hypert able optimized for time-series data
    ...
    \subsection{\textbf{Hardware Simulator (Python-based IoT Mock)}}
        ...
        \subsubsection{Realistic Scenarios}
        \subsubsection{WebSocket Integration}
        \subsubsection{Prediction Algorithm}
        \subsubsection{Integration with Device Control}
...
\section{Architecture Design \& Implementation}
    ...
    \subsection{Next.js Frontend}
        For the PureCare Air Purifier to have apathetic intelligence, we needed a way to deliver this sentiment to the user. To do this, we made a Next.js based Progressive Web App. The app allows us to communicate and receive inputs from users, making for a truly responsive design. Within the app, users are able to register, control, and receive real time data from the air purifier.
